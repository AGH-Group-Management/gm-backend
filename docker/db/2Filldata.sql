...
INSERT into users (name, surname, email, roleid, password) VALUES ('Marek', 'Gajęcki', 'mag@agh.edu.pl', 2, 'ala12345678'),
                                                                  ('Jan', 'Nowak', 'jnowak@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Marcin', 'Kowalski', 'mkowalski@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Agnieszka', 'Wojciechowska', 'awojciechowska@student.agh.edu.pl', 3, 'ala123'),
                                                                  ('Łukasz', 'Nowicki', 'lnowicki@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Mateusz', 'Kamiński', 'mkaminski@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Marencjusz', 'Garkowski', 'wizard@agh.edu.pl',2, 'ala123'),
                                                                  ('Marta', 'Jankowska', 'mjankowska@student.agh.edu.pl', 3, 'ala123'),
                                                                  ('Katarzyna', 'Szymańska', 'kszymanska@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Kamil', 'Wróbel', 'kwrobel@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Natalia', 'Zielińska', 'nzielinska@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Karolina', 'Lewandowska', 'klewandowska@student.agh.edu.pl', 3, 'ala123'),
                                                                  ('Michał', 'Kowalczyk', 'mkowalczyk@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Patryk', 'Kaczmarek', 'pkaczmarek@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Natalia', 'Piotrowska', 'npiotrowska@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Aleksander', 'Zając', 'azajac@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Weronika', 'Grabowska', 'wgrabowska@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Kacper', 'Michalski', 'kmichalski@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Dominika', 'Nowakowska', 'dnowakowska@student.agh.edu.pl', 2, 'ala123'),
                                                                  ('Konrad', 'Jabłoński', 'kjablonski@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Martyna', 'Sikora', 'msikora@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Mikołaj', 'Olszewski', 'molszewski@student.agh.edu.pl', 1, 'ala123'),
                                                                  ('Nikola', 'Kaczmarczyk', 'nkaczmarczyk@student.agh.edu.pl', 1, 'ala123');
